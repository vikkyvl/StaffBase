...
"}")
        ...
        self.department_lineEdit = QtWidgets.QLineEdit(self.frame)
        self.department_lineEdit.setGeometry(QtCore.QRect(110, 150, 241, 35))
        font = QtGui.QFont()
        font.setFamily("Caros Light")
        font.setPointSize(14)
        self.department_lineEdit.setFont(font)
        self.department_lineEdit.setStyleSheet("QLineEdit {\n"
"    background-color: rgb(255, 255, 255);\n"
"    border: 2px solid  rgb(0, 31, 63);\n"
"    border-radius: 8px; \n"
"    padding: 5px; \n"
"    font-size: 14pt;\n"
"}")
        self.department_lineEdit.setMaxLength(100)
